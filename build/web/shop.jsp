...
<html>
    ...
    <body>
        ...
        { image: "https://drive.google.com/file/d/1J4WFRe6kls3elCcO7znH0Hppp1dXyPZz/view?usp=drive_link", name: "BRILINTA 90MG TAB 56S", description: "This medication is used to treat high blood pressure (hypertension). Side Effects, Dizziness or lightheadedness may occur as your body adjusts to the medication. When not to use, It is contraindicated in patients with known hypersensitivity to the drug.", price: 302.54 },
                    { image: "image2.jpg", name: "PLAVIX 75MG TABS 28 S", description: "Active ingredient clopidogrel hydrogen sulfate. Plavix 75 mg film-coated tablets Each film-coated tablet contains 75 mg of clopidogrel (as hydrogen sulphate). Core: Mannitol (E421) Macrogol 6000 Microcrystalline cellulose Hydrogenated castor oil Low substituted hydroxypropylcellulose Coating: Hypromellose (E464) Lactose monohydrate Triacetin (E1518) Titanium dioxide (E171) Red iron oxide (E172) Polishing agent: Carnauba wax", price: 34.72  },
        
         { image: "image7.jpg", name: "PLAVIX 75MG TABS 28 S", description: "Active ingredient clopidogrel hydrogen sulfate. Plavix 75 mg film-coated tablets Each film-coated tablet contains 75 mg of clopidogrel (as hydrogen sulphate). Core: Mannitol (E421) Macrogol 6000 Microcrystalline cellulose Hydrogenated castor oil Low substituted hydroxypropylcellulose Coating: Hypromellose (E464) Lactose monohydrate Triacetin (E1518) Titanium dioxide (E171) Red iron oxide (E172) Polishing agent: Carnauba wax", price: 300.24  },
        { image: "image9.jpg", name: "MINIPRESS XL 5MG TABPLAVIX 75MG TABS 28 S", description: ", This medication is used to treat high blood pressure (hypertension). Side Effects, Dizziness or lightheadedness may occur as your body adjusts to the medication. When not to use, It is contraindicated in patients with known hypersensitivity to the drug.", price: 34.72  },
        
        { image: "10.jpeg", name: "NEBIVAS 5MG TAB 50 S", description: "This medication is used to treat high blood pressure (hypertension). Side Effects, Dizziness or lightheadedness may occur as your body adjusts to the medication. When not to use, It is contraindicated in patients with known hypersensitivity to the drug.", price: 73.44  },
        
         { image: "image11.jpg", name: "BUDEMATE NASL SPRAY 64MCG", description: "Active ingredient clopidogrel hydrogen sulfate. Plavix 75 mg film-coated tablets Each film-coated tablet contains 75 mg of clopidogrel (as hydrogen sulphate). Core: Mannitol (E421) Macrogol 6000 Microcrystalline cellulose Hydrogenated castor oil Low substituted hydroxypropylcellulose Coating: Hypromellose (E464) Lactose monohydrate Triacetin (E1518) Titanium dioxide (E171) Red iron oxide (E172) Polishing agent: Carnauba wax", price: 34.72  },
        { image: "10.jpeg", name: "NEBIVAS 5MG TAB 50 S", description: "This medication is used to treat high blood pressure (hypertension). Side Effects, Dizziness or lightheadedness may occur as your body adjusts to the medication. When not to use, It is contraindicated in patients with known hypersensitivity to the drug.", price: 73.44  },
