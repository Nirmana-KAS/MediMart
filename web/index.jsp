...
<html>
  <head>
    ...
    <body>
      ...
      <section class="hero-section">
        <img src="images/index/b3.jpg" alt="hero Background Image" style="position:relative;width: 2000px; height: 1000px; z-index: -1;">
    ...
    <div class="section2">
      <div class="slide">
        <img src="images/index/nfoods.jpg" alt="Image 1">
        <div class="info-box">
      ...
      <div class="slide">
        <img src="images/index/daily essentials.jpg" alt="Image 2">
        <div class="info-box">
          <h2>Daily Health<br> Essentials</h2>
          <p><b>Up To 15% OFF</b><br><br><button class="custom-button">Shop Now</button></p>
        </div>
      </div>
      <div class="slide">
        <img src="images/index/medicine.jpg" alt="Image 3">
        <div class="info-box">
      ...
      <div class="slide">
        <img src="images/index/healthcare.jpg" alt="Image 4">
        <div class="info-box">
    ...
    <div class = "info-content">
     <img src="images/index/a.jpg" alt="Image 5">  
     <div class="info-box" >     
    ...
    <div class = "info-content">
      <img src="images/index/c.jpg" alt="Image 6">
      <div class="info-box">  
  ...
  <div class = "info-content">
    <img src="images/index/b.jpg" alt="Image 7">
    <div class="info-box">  
       <h2>Generic Medicines & Prescription Drugs</h2>
       <p>Quality medicine ensures safe and effective treatment. Trust in your prescription's efficacy and safety with rigorously tested medications meeting stringent quality standards.</p>
    </div>
  </div>
  </div>
</div>
  <div class="content">
    ...
    <p>Conveniently access prescription medications and healthcare essentials from the comfort of your home with our online pharmacy.
      Browse a <br>wide selection of trusted medications, wellness products, and expert advice, all delivered straight to your doorstep.
  ...
  <div class ="description2">
    <div class = "info-content2">
      <img src="images/index/delivery.jpg" alt="Image 8">  
      <div class="info-box1" >     
      <h2>Free & Fast Delivery</h2>
    </div>
  </div>  
  <div class = "info-content2">
    <img src="images/index/save money.jpg" alt="Image 9">
    <div class="info-box1">  
    <h2>Saving Money</h2>
  </div>
</div>  
<div class = "info-content2">
    <img src="images/index/time saving.jpg" alt="Image 10">
    <div class="info-box1">  
    <h2>Saving Time</h2>
  </div>
</div>
...
<div class="description6">
  <div class="content6">
    ...
    <p>Discover a world where excellence meets health in our collection of high-quality products and medicines. Crafted with precision and care,each item embodies
        a commitment to your well-being, offering a blend of efficacy, safety, and reliability. From cutting-edge pharmaceuticals to premium wellness essentials,
  ...
  <div class="slide6">
    <img src="images/index/c1.jpg" alt="Image 11">
  </div>
</div>
<div class="description5">
  ...
  <div class="section5">
  <div class="slide">
    <img src="images/index/img1.jpg" alt="Image 12">
  </div>
  <div class="slide">
    <img src="images/index/img 2.jpg" alt="Image 13">
  </div>
  <div class="slide">
    <img src="images/index/img3.jpg" alt="Image 14">
  </div>
  <div class="slide">
    <img src="images/index/img4.jpg" alt="Image 15">
  </div>
  <div class="slide">
    <img src="images/index/img5.jpg" alt="Image 16">
  </div>
  </div>
  <div class="section6">
...
<div class="description3">
  ...
  <div class="description4">
    <div class="info-content3">
      <img src="images/index/covid-19.jpg" alt="Image 17">  
      <div class="info-box3" >     
    ...
    <div class="info-content3">
      <img src="images/index/future.jpg" alt="Image 18">  
      <div class="info-box3" >     
    ...
    <div class="info-content3">
      <img src="images/index/migraine.jpeg" alt="Image 19">  
      <div class="info-box3" >     
